...
- Every task has a GitHub issue (`T1` is [#9](https://github.com/rons-space/Wanderer/issues/9)
  through `T58` at [#66](https://github.com/rons-space/Wanderer/issues/66)), labelled by stage,
  severity and area, and grouped into a milestone per stage. Work one issue at a time; this file is
  the index and the rationale, the issue is the unit of work.
...
- [ ] [#25](https://github.com/rons-space/Wanderer/issues/25) **T17: Sign the installer and add an updater** (Finding 7.2, **High**)
